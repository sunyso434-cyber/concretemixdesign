...
class UnifiedOrchestrator {
  ...
  async run({ sessionId, message, mode = 'collaborative', webContents = null }) {
    ...
    console.log('[UnifiedOrchestrator] run() 开始, sessionId:', sessionId, 'mode:', mode, 'wc:', !!webContents)
    ...
    try {
      ...
      console.error('[UnifiedOrchestrator] run() 顶层异常:', outerError.message)
