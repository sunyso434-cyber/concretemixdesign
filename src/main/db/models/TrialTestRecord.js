...
const TrialTestRecord = sequelize.define('TrialTestRecord', {
  ...
  sand_amount: { type: DataTypes.FLOAT, comment: '砂总用量' },
  sand1_amount: { type: DataTypes.FLOAT, comment: '砂1用量' },
  sand2_amount: { type: DataTypes.FLOAT, comment: '砂2用量' },
  stone_amount: { type: DataTypes.FLOAT, comment: '石总用量' },
  stone1_amount: { type: DataTypes.FLOAT, comment: '石1用量' },
  stone2_amount: { type: DataTypes.FLOAT, comment: '石2用量' },
