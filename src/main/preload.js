...
const INVOKE_CHANNELS = new Set([
  ...
  // Skill 管理（create/delete/getInfo 由 SkillManager 调用，补齐白名单）
  'skill:getInfo',
  'skill:create',
  'skill:delete',
  // 试配记录
